...
import {COLORS, PIECES} from '../../common/constants';
      ...
      <div style={overlayStyle}>
        <div style={{position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)'}}>
          <div style={{backgroundColor: 'rgba(255, 255, 255, 0)'}}>
            <img
              onClick={() => this.handleClick(this.props.color === COLORS.WHITE ? PIECES.QUEENW : PIECES.QUEENB)}
              src={this.props.color === COLORS.WHITE ? queenw : queenb}
              className="piece"
            />
            <img
              onClick={() => this.handleClick(this.props.color === COLORS.WHITE ? PIECES.ROOKW : PIECES.ROOKB)}
              src={this.props.color === COLORS.WHITE ? rookw : rookb}
              className="piece"
            />
            <img
              onClick={() => this.handleClick(this.props.color === COLORS.WHITE ? PIECES.KNIGHTW : PIECES.KNIGHTB)}
              src={this.props.color === COLORS.WHITE ? knightw : knightb}
              className="piece"
            />
            <img
              onClick={() => this.handleClick(this.props.color === COLORS.WHITE ? PIECES.BISHOPW : PIECES.BISHOPB)}
